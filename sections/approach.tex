...
\subsection{Communication protocols}\label{sec:protocols}
  ...
  \Cref{protocol:downing} then describes the downing protocol, which ensures that all nodes only shut down if no work is available in the whole cluster any more.
...
\subsubsection{Work stealing protocol}\label{protocol:workStealing}
 ...
 % To achieve this goal the Master actors of the different nodes exchange their current workload with each other.\\
